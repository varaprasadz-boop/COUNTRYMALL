...
class EmployeeController extends BaseController
{
    ...
    public function getAddView(): View
    {
        ...
        // Fetch vendors
        $vendors = $this->vendorRepo->getListWhere(dataLimit: 'all');

        // Pass both to the view
        return view(Employee::ADD[VIEW], compact('employee_roles', 'vendors'));
    }
    ...
    public function getVendorAddView(Request $request): View
    {
        $vendors = $this->vendorRepo->getListWhere(dataLimit: 'all');
        // dd('sdsdsdsd',$vendors);  // This will dump the result and continue.
        return view(Employee::ADD[VIEW], compact('vendors'));
    }
}
