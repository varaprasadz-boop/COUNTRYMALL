                                        ...
                                        @if(getWebConfig('map_api_status') ==1 )
                                            <div class="col-md-12">
                                                <div class="form-group map-area-alert-border location-map-address-canvas-area">
                                                    ...
                                                    <div class="__h-400px" id="location_map_canvas"></div>
                                                </div>
                                            </div>
                                        @endif
                                ...
                                <section class="col-lg-6 col-md-6">
                                    <div class="card __shadow h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($shippingAddress['is_primary'] == 0)
                                                <div>
                                                    <span class="font-nameA">
                                                        <form method="post" action="">
                                                            ...
                                                            <input type="submit" class="btn btn-primary btn-sm" style="font-size:11px !important;" value="{{translate('make_primary')}}">
                                                            </label>
                                                        </form>
                                                    </span>
                                                </div>
