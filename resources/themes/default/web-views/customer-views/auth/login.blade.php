...
@push('script')
    ...
    @if($customerOTPLogin && !$customerManualLogin)
        @include("web-views.customer-views.auth.partials._phone-js")
    @endif
    <script>
        @if($customerOTPLogin && $customerManualLogin)
            $(document).on('click', '.otp-login-btn', function () {
                ...
                $('.otp-login-btn').addClass('d-none');
                $('.manual-login-btn').removeClass('d-none');
            })
            $(document).on('click', '.manual-login-btn', function () {
                $('.manual-login-items').removeClass('d-none');
                $('.otp-login-items').addClass('d-none');
                $('.manual-login-btn').addClass('d-none');
