                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                <label class="title-color mb-0">
                                    MRP ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})
                                    <span class="input-required-icon">*</span>
                                </label>
                            ...
                            <input type="number" min="0" step="0.01"
                                ...
                                id="unit_price" value="{{ old('unit_price') }}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                <label class="title-color mb-0">
                                    Selling Price ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})
                                </label>
                            </div>
                            <input type="number" id="selling_price" class="form-control" placeholder="Selling Price" readonly>
                        </div>
                    </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', () => {
                            ...
                            function calculateSellingPrice() {
                                ...
                                const sellingPrice = unitPrice - discount;
                                sellingPriceInput.value = sellingPrice.toFixed(2); // Ensure 2 decimal places
                            }
