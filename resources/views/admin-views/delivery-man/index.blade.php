                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{old('phone')}}" type="text" name="phone" class="form-control" placeholder="{{translate('ex').':'.'9908********'}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="vendor_id" class="form-control js-select2-custom">
                                        ...
                                        <option value="{{ $vendor->id }}" {{old('vendor_id') == $vendor->id? 'selected' : ''}}>{{ $vendor->f_name }} ({{ $vendor->shop->name }}) </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="identity_type" class="form-control">
                                        ...
                                        <option value="aadhar">{{translate('aadhar')}}</option>
