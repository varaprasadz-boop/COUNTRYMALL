        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-3 flex-wrap flex-lg-nowrap">
                ...
                <div class="row gy-3 flex-grow-1 w-100">
                    ...
                    <div class="col-xxl-6">
                        <div class="bg-light p-3 border border-primary-light rounded">
                            <h4 class="mb-3 text-capitalize">{{translate('Payment and billing information')}}</h4>

                            <div class="d-flex gap-5">
                                <div class="pair-list">
                                    <div>
                                        <span class="key text-nowrap">{{translate('payment_method')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value ">{{ $seller['payment_method'] ?? translate('no_data_found') }}</span>
                                    </div>

                                    <div>
                                        <span class="key text-nowrap">{{translate('payment_terms')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['payment_terms'] ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                                <div class="pair-list">
                                    <div>
                                        <span class="key text-nowrap">{{translate('billing_contact_name')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['billing_contact_name'] ?? translate('no_data_found') }}</span>
                                    </div>

                                    <div>
                                        <span class="key text-nowrap">{{translate('billing_contact_email')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['billing_contact_email'] ?? translate('no_data_found') }}</span>
                                    </div>
                                    <div>
                                        <span class="key text-nowrap">{{translate('billing_contact_phone')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['billing_contact_phone'] ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                                <!-- <div class="pair-list">
                    ...
                    <div class="col-xxl-6">
                        <div class="bg-light p-3 border border-primary-light rounded">
                            <h4 class="mb-3 text-capitalize">{{translate('Product or service information')}}</h4>

                            <div class="d-flex gap-5">
                                <div class="pair-list">

                                    <div>
                                        <span class="key text-nowrap">{{translate('provides_warranty')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['provides_warranty'] ? translate('yes') : translate('no') ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex gap-5">
                            <div class="pair-list">
                                    <div>
                                        <span class=" text-nowrap">{{translate('warranty_details')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['warranty_details'] ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex gap-5">
                                <div class="pair-list">
                                <div>
                                        <span class=" text-nowrap">{{translate('primary_products_services')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value ">{{ $seller['primary_products_services'] ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-6">
                        <div class="bg-light p-3 border border-primary-light rounded">
                            <h4 class="mb-3 text-capitalize">{{translate('Business information')}}</h4>

                            <div class="d-flex gap-5">
                                <div class="pair-list">
                                    <div>
                                        <span class="key text-nowrap">{{translate('business_type')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value ">{{ $seller['business_type'] ?? translate('no_data_found') }}</span>
                                    </div>

                                    <div>
                                        <span class="key text-nowrap">{{translate('primary_industry')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['primary_industry'] ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                                <div class="pair-list">
                                    <div>
                                        <span class="key text-nowrap">{{translate('years_in_business')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['years_in_business'] ?? translate('no_data_found') }}</span>
                                    </div>

                                    <div>
                                        <span class="key text-nowrap">{{translate('Registration No')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['business_registration_number'] ?? translate('no_data_found') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex gap-5">
                            <div class="pair-list">
                                    <div>
                                        <span class="key text-nowrap">{{translate('business_address')}}</span>
                                        <span class="px-2">:</span>
                                        <span class="value">{{ $seller['business_address'] ?? translate('no_data_found') }}</span>
                                    </div>
