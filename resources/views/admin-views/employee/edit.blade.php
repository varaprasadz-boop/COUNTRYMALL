                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="identify_type" id="identify_type">
                                        ...
                                        <option value="nid" {{$employee->identify_type == 'nid' ?'selected' : ''}}>{{translate('aadhar')}}</option>
                                        <option value="driving_license" {{$employee->identify_type == 'driving_license' ?'selected' : ''}}>{{translate('driving_License')}}</option>
                                    </select>
                                </div>
                                <div class="form-group">
